...
import pretitleImage from '../public/img/hero/pretitle-img.svg'
      ...
      <div className='container mx-auto flex justify-start items-center min-h-[400px] lg:min-h-[805px]'>
        <div className='lg:max-w-[650px] text-center mx-auto lg:text-left lg:mx-0'>
          <div className='hidden xl:flex mb-6 ml-5'>
            <Image src={pretitleImage} width={'100%'} height={'auto'} alt='' />
          </div>
          <h1 className='text-5xl lg:text-8xl uppercase font-bold -tracking-[0.05em] mb-10'>A pet first <br />{' '}
            <span className='text-orange font-normal'>approach to</span><br /> wellness</h1>
